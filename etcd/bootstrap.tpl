...
/usr/local/bin/product-install ${customer}-barge-etcd ${environment}
/usr/local/bin/emeril ${customer}-barge-etcd

/usr/local/bin/product-install ${customer}-barge-etcd-datadog ${environment}
/usr/local/bin/emeril ${customer}-barge-etcd-datadog
